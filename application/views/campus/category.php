		...
		foreach($item_ratings as $k => $v): ?>
			<tr bgcolor="<?php echo $bgcolor ?>">
				...
				<td align="right">
					...
					href="/<?php echo $campus->university_slug."/".$category->category_slug."/".$v->slug."/share" ?>"><img src="<?php echo base_url(); ?>images/share_email.gif" border="0" height="24" width="24" alt="share to email" /></a></td>
			</tr>
		<?
			if ($bgcolor=="#e1e1e1")
				{
