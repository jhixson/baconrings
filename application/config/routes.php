...
$route['(:any)/(:any)/(:any)/(:any)/flag'] = 'forms/flag/$1/$3/$4';
$route['(:any)/(:any)/(:any)/flag-thanks'] = 'forms/flagthanks/$1/$3';
$route['(:any)/(:any)/flag'] = 'forms/flag/$1/$2';
$route['(:any)/flag-thanks'] = 'forms/flagthanks/$1';
